 ...
 <style>
    ...
    .pagination .page-link:hover {
        ...
        background-color: #e13837; /* Màu nền khi hover */
        border-color: #e13837; /* Màu viền khi hover */
    }

    .pagination .page-item.active .page-link {
        color: #fff; /* Màu chữ khi active */
        background-color: #e13837; /* Màu nền khi active */
        border-color: #e13837; /* Màu viền khi active */
    }
    .ajaxSearch{
        position: relative;
    }
